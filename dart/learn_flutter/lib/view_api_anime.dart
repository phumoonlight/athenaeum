...
class ApiAnime extends StatefulWidget {
  const ApiAnime({super.key});

  @override
  State<ApiAnime> createState() => _State();
}

class _State extends State<ApiAnime> {
  int count = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("API Anime")),
      body: Center(
